...
<section class="bg-light" style="padding-top: 60px;">
  <div >
    <div class="jumbotron">
      ...
      <p class="lead"><strong>Un partenaire incontournable dans le domaine du nettoyage industriel et des analyses des engrais</strong></p>
    </div>
  </div>
</section>
...
<section class="bg-light" style="padding-top: 60px;">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <p class="text-justify" style="font-size: 18px; line-height: 1.6;">Le laboratoire OUBABA vise essentiellement à fournir des compétences, proposer des formations pratiques et apporter une assistance en ce qui concerne les analyses physico-chimiques, agricoles, environnement, pétrolières et minières.</p>
        <p class="text-justify" style="font-size: 18px; line-height: 1.6;">Afin de répondre aux exigences requises, le laboratoire OUBABA s'est engagé dans une démarche dynamique et collective d'amélioration continue pour l'obtention de l'accréditation NM ISO/CEI 17025 version 2017 pour les activités d'analyses.</p>
        <p class="text-justify" style="font-size: 18px; line-height: 1.6;">Le laboratoire OUBABA dispose d'une grande expérience en matière des analyses depuis 2020, il dispose également des meilleurs équipements, personnel et expérience pour fournir des résultats d'analyses.</p>
      </div>
      <div class="col-md-6">
        <img src="images/oubaba_logo.png" class="img-fluid" alt="Laboratoire OUBABA" style="width: 100%; height: auto;">
      </div>
    </div>
  </div>
</section>
  ...
  <section class="bg-light" style="padding-top: 60px;">
    <div class="container py-8">
      <div class="row">
        <div class="col-md-12">
          <p class="text-justify" style="font-size: 18px; line-height: 1.6;">Le contrôleur de la production des engrais utilise une interface machine pour surveiller et ajuster les installations de production. Il reçoit les analyses de laboratoire OUBABA via l'application Ferticheck, ce qui lui permet de modifier les paramètres de production pour garantir la conformité du produit final et éviter les problèmes. Cela assure la qualité et l'efficacité des produits engrais.</p>
        </div>
        <div class="col-md-12">
          <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <a class="carousel-control-prev custom-icon" href="#carouselExampleIndicators" role="button" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </a>
            <a class="carousel-control-next custom-icon" href="#carouselExampleIndicators" role="button" data-bs-slide="next">
  ...
  <section class="bg-light" style="padding-top: 60px;">
    <div class="container services">
        ...
        <p class="text-center">L'application FertiCheck offre une plateforme complète de gestion des analyses des engrais. Grâce à nos services, vous pouvez facilement surveiller et optimiser l'utilisation des engrais dans votre activité agricole. Voici les principaux services que nous proposons.</p>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
