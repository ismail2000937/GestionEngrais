...
<head>
    ...
    <title>controleur moyenne acide</title>
...
<body>
    ...
    <div class="container" id="marg">
        ...
        <table class="table table-striped">
            <thead>
                <tr class="border">
                    <td colspan="3" >Saiseur : <strong>{{ $resultatmoyenne['saiseur'] }}</strong></td>
                    <td colspan="3" >Nom d'unite : <strong> {{ $resultatmoyenne['nom_ligne'] }}</strong></td>
                </tr>

                <tr class="border">
                    <td colspan="3" >Nom produit : <strong> {{ $resultatmoyenne['nom_produit'] }}</strong></td>
                    <td colspan="5" >date de saisi : <strong>{{ $resultatmoyenne['date_saisi'] }}</strong></td>
                </tr>
